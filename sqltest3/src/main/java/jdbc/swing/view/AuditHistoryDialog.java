...
public class AuditHistoryDialog extends JDialog {
	...
	private JLabel playerAuditHistoryLabel;
	...
	public void populate(Player newPlayer, List<AuditHistory> auditHistoryList) {
		
		playerAuditHistoryLabel.setText(newPlayer.getNickName() + " " + newPlayer.getProfession());
	...
	public AuditHistoryDialog() {
		...
		contentPanel.setLayout(new BorderLayout(0, 0));
		{
			...
			{
				playerAuditHistoryLabel = new JLabel("New label");
				panel.add(playerAuditHistoryLabel);
			}
		}
		{
